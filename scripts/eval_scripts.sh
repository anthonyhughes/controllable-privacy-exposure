...
PYTHONPATH=/Users/anthonyhughes/PhD/controllable-privacy-exposure/ nohup python pipelines/eval_pipeline.py -t cnn -m llamonymous-3-8b-bnb-4bit -e utility -st all &